...
import { getOrderDetails } from "../../reducers/orderDetails";
...
const ProcessOrder = () => {
  ...
  const updateOrderSubmitHandler = (e) => {
    ...
    dispatch(updateOrderStatus({ orderId, myForm }));
  };
  ...
  }, [dispatch, error, orderId, success, updateError]);
